...
%Macro Charges;
	data modele.rev_imp&anr1.;
		...
		if _6qr=1 then do; /* mutualisation des plafonds de déduction des conjoints */
			if _6RS_plaf>0 then do;
				if _6RS_plaf=_6ps and _6RT_plaf ne _6pt then
					/*si le conjoint n'a pas atteint son plafond, le déclarant l utilise*/
					_6RS_plaf=Max(0,_6RS_plaf-(_6pt-_6RT_plaf));
				end;
			if _6RT_plaf>0 then do;
				if _6RS_plaf ne _6ps and _6RT_plaf=_6pt then
					/*si le déclarant n a pas atteint son plafond, le conjoint l utilise*/
