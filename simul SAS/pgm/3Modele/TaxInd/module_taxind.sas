	/*****************************************************************/
	/* 							module de taxation indirecte 						*/

/*ce programme rassemble le bloc du module de taxation indirecte effectuant 
le calcul de la consommation pour les ménages de basemen et le calcul des taxes
=> se reporter au wiki ou au document de travail */
...
%macro module_TaxInd;
		%if &inclusion_TaxInd.=oui %then %do; 
			%include "&taxind./1_Taux_consommation_epargne.sas";
			%include "&taxind./2_Calcul_taxes.sas";
			%include "&taxind./3_Sorties_Taxind.sas";
		%end;
%mend;
%module_TaxInd;
