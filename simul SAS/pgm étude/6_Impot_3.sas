...
%macro Impot;
	...
	%ELSE %IF "&calcul_impot." = "impot_revdisp" %THEN %DO;
		...
		*****************************/
		...
		impot71=impot61-credit-reduc_exceptionnel_17;
		impot72=impot62;
		impot73=impot63;
		impot74=impot64;
		impot75=impot65;
		...
		*****************************/
		...
		/* MODIF 3 ICI : on retire le crédit d'impôt par personne à charge, qu'on suppose non plafonné */
		impot10=impot9-&ci_pac.*npcha;

		/***************************
		X. Mise en recouvrement
		*****************************/
		/* MODIF 3 ICI : on remplace impot9 par impot10 */
		impot = impot10;
		if 0<impot10<&recouv. then impot=0;
